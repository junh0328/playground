...
description: |
  CTO 수준의 프론트엔드 과제 평가용 Codex skill. 채용 과제를 체계적으로 분석하고 객관적인 평가 리포트를 생성합니다.
  사용 상황:
  - 프론트엔드 채용 과제를 평가할 때
...
프론트엔드 채용 과제를 CTO 관점에서 체계적으로 평가하는 Codex용 전문 스킬입니다.
...
평가 요청을 받으면 아래 순서로 진행합니다. 필요한 정보가 비어 있으면 먼저 질문으로 보완한 뒤 평가를 시작합니다.
...
`references/checklist.md`의 체크리스트에 따라 평가 진행.
